...
```javascript
import map3d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map3d@v0.2.3-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map3d@v0.2.3-esm/index.mjs';
```
