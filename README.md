...
```javascript
import map3d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map3d@v0.1.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map3d@v0.1.0-esm/index.mjs';
```
